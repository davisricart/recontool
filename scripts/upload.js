...
// *** IMPORTANT FIX ***
// Modified to export properly - don't just return the function
// We need to return an object with the function as a property
// so it can be properly accessed by the calling code
module.exports = {
